...
class CityscapesDataSet(data.Dataset):
    ...
    """
    def __init__(self, root, list_path, max_iters=None, crop_size=(512, 1024), mean=(128, 128, 128), scale=True, mirror=True, 
            ignore_label=255 ):
        self.root = root
...
class CityscapesTestDataSet(data.Dataset):
    ...
    """
    def __init__(self, root, list_path='test.txt', mean=(128, 128, 128), ignore_label=255):
        self.root = root
        self.list_path = list_path
        self.ignore_label = ignore_label
        self.mean = mean
...
class CityscapesTrainInform:
    ...
    """
    def __init__(self, data_dir, classes, train_set_file="cityscapes_train_list.txt", inform_data_file="cityscapes_inform.pkl", normVal=1.10):
        """
        Args:
